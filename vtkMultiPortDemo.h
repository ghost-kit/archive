#ifndef __vtkMultiPortDemo_H__
#define __vtkMultiPortDemo_H__

#include "vtkStructuredGridAlgorithm.h"
#include "vtkDelimitedTextReader.h"

class VTK_EXPORT vtkMultiPortDemo : public vtkStructuredGridAlgorithm
{
 public:
  static vtkMultiPortDemo *New();
  vtkTypeMacro(vtkMultiPortDemo, vtkStructuredGridAlgorithm);
  ...
  virtual void SetFileName(const char *fileName) { this->SetfileName(fileName); }
  vtkGetStringMacro(fileName);
  virtual char *GetFileName() { return this->GetfileName(); }
...
private:
  vtkMultiPortDemo(const vtkMultiPortDemo&); // Not implemented
  void operator=(const vtkMultiPortDemo&); // Not implemented
};
